...
public final class CrockPotBlocks {
    ...
    public static final RegistryObject<Block> CANDY = BLOCKS.register("candy", CrockPot6StacksFoodBlock::new);
    public static final RegistryObject<Block> CEVICHE = BLOCKS.register("ceviche", CrockPotFoodBlock::new);
    public static final RegistryObject<Block> FISH_STICKS = BLOCKS.register("fish_sticks", CrockPot2StacksFoodBlock::new);
    ...
    public static final RegistryObject<Block> FRUIT_MEDLEY = BLOCKS.register("fruit_medley", CrockPot3StacksFoodBlock::new);
    public static final RegistryObject<Block> GAZPACHO = BLOCKS.register("gazpacho", CrockPot3StacksFoodBlock::new);
    ...
    public static final RegistryObject<Block> HOT_COCOA = BLOCKS.register("hot_cocoa", CrockPot3StacksFoodBlock::new);
    public static final RegistryObject<Block> ICE_CREAM = BLOCKS.register("ice_cream", CrockPotFoodBlock::new);
    public static final RegistryObject<Block> ICED_TEA = BLOCKS.register("iced_tea", CrockPot3StacksFoodBlock::new);
    public static final RegistryObject<Block> JAMMY_PRESERVES = BLOCKS.register("jammy_preserves", CrockPotFoodBlock::new);
    public static final RegistryObject<Block> KABOBS = BLOCKS.register("kabobs", CrockPot3StacksFoodBlock::new);
    public static final RegistryObject<Block> MASHED_POTATOES = BLOCKS.register("mashed_potatoes", CrockPot4StacksFoodBlock::new);
    ...
    public static final RegistryObject<Block> POTATO_SOUFFLE = BLOCKS.register("potato_souffle", CrockPot4StacksFoodBlock::new);
    public static final RegistryObject<Block> POTATO_TORNADO = BLOCKS.register("potato_tornado", CrockPot3StacksFoodBlock::new);
    public static final RegistryObject<Block> POW_CAKE = BLOCKS.register("pow_cake", PowCakeBlock::new);
    public static final RegistryObject<Block> PUMPKIN_COOKIE = BLOCKS.register("pumpkin_cookie", CrockPot2StacksFoodBlock::new);
    public static final RegistryObject<Block> RATATOUILLE = BLOCKS.register("ratatouille", CrockPotFoodBlock::new);
    public static final RegistryObject<Block> SALMON_SUSHI = BLOCKS.register("salmon_sushi", CrockPot3StacksFoodBlock::new);
    ...
    public static final RegistryObject<Block> TAFFY = BLOCKS.register("taffy", CrockPot6StacksFoodBlock::new);
    public static final RegistryObject<Block> TEA = BLOCKS.register("tea", CrockPot2StacksFoodBlock::new);
    ...
    public static final RegistryObject<Block> WATERMELON_ICLE = BLOCKS.register("watermelon_icle", CrockPot3StacksFoodBlock::new);
