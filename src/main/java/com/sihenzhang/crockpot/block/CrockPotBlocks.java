...
public final class CrockPotBlocks {
    ...
    public static final RegistryObject<Block> FISH_STICKS = BLOCKS.register("fish_sticks", () -> CrockPotStackableFoodBlock.of(BlockBehaviour.Properties.of().sound(SoundType.SWEET_BERRY_BUSH), 2));
