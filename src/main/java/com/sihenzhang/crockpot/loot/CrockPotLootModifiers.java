...
public final class CrockPotLootModifiers {
    ...
    public static final RegistryObject<GlobalLootModifierSerializer<FishingLootModifier>> FISHING = LOOT_MODIFIER_SERIALIZERS.register("fishing", FishingLootModifier.Serializer::new);
}
