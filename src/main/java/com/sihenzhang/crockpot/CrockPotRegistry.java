...
public final class CrockPotRegistry {
    ...
    public static final RegistryObject<EntityType<Birdcage>> BIRDCAGE_ENTITY = ENTITIES.register("birdcage", () -> EntityType.Builder.of(Birdcage::new, MobCategory.MISC).sized(0.0001F, 0.0001F).setUpdateInterval(20).setTrackingRange(256).build(RLUtils.createRL("birdcage").toString()));
    ...
    public static final RegistryObject<EntityType<ThrownParrotEgg>> PARROT_EGG_ENTITY = ENTITIES.register("parrot_egg", () -> EntityType.Builder.<ThrownParrotEgg>of(ThrownParrotEgg::new, MobCategory.MISC).sized(0.25F, 0.25F).clientTrackingRange(4).updateInterval(10).build(RLUtils.createRL("parrot_egg").toString()));
