...
public final class CrockPotRegistry {
    ...
    public static RegistryObject<Item> ceviche = ITEMS.register("ceviche", () -> CrockPotFood.builder().hunger(7).saturation(0.7F).setAlwaysEdible().effect(Effects.RESISTANCE, 20 * 20, 1).effect(Effects.ABSORPTION, 20 * 20, 1).effect(Effects.INVISIBILITY, 20 * 20).build());
