...
//    public static final EntityType<BirdcageEntity> birdcageEntity = register(ENTITIES, "birdcage", EntityType.Builder.<BirdcageEntity>create((entityType, world) -> new BirdcageEntity(world), EntityClassification.MISC).setCustomClientFactory((spawnEntity, world) -> new BirdcageEntity(world)).size(0.0F, 0.0F).build(CrockPot.MOD_ID + ":birdcage"));
    ...
    public static final Item pepper = register(ITEMS, "pepper", CrockPotFood.builder().nutrition(3).saturationMod(0.6F).damage(CrockPotDamageSource.SPICY, 1).hideEffects().build());
...
//    public static final EntityType<BirdEggEntity> birdEggEntity = register(ENTITIES, "bird_egg", EntityType.Builder.<BirdEggEntity>create((entityType, world) -> new BirdEggEntity(world), EntityClassification.MISC).size(0.25F, 0.25F).trackingRange(4).updateInterval(10).build(CrockPot.MOD_ID + ":bird_egg"));
    ...
    // Foods
    public static final Item asparagusSoup = register(ITEMS, "asparagus_soup", CrockPotFood.builder().nutrition(4).saturationMod(0.3F).duration(FoodUseDuration.FAST).alwaysEat().drink().removeEffect(Effects.WEAKNESS).removeEffect(Effects.DIG_SLOWDOWN).removeEffect(Effects.BLINDNESS).removeEffect(Effects.BAD_OMEN).build());
    public static final Item avaj = register(ITEMS, "avaj", CrockPotFood.builder().nutrition(2).saturationMod(3.6F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(Effects.MOVEMENT_SPEED, (32 * 60 + 20) * 20, 2).hide().rarity(Rarity.EPIC).build());
    ...
    public static final Item boneSoup = register(ITEMS, "bone_soup", CrockPotFood.builder().nutrition(10).saturationMod(0.6F).effect(Effects.ABSORPTION, 2 * 60 * 20, 1).build());
    public static final Item boneStew = register(ITEMS, "bone_stew", CrockPotFood.builder().nutrition(20).saturationMod(0.4F).duration(FoodUseDuration.SUPER_SLOW).effect(Effects.HEAL, 1, 1).build());
    public static final Item bunnyStew = register(ITEMS, "bunny_stew", CrockPotFood.builder().nutrition(6).saturationMod(0.8F).effect(Effects.REGENERATION, 5 * 20).effect(CrockPotRegistry.wellFed, 3 * 60 * 20).build());
    public static final Item californiaRoll = register(ITEMS, "california_roll", CrockPotFood.builder().nutrition(10).saturationMod(0.6F).heal(4.0F).effect(Effects.ABSORPTION, 60 * 20).build());
    public static final Item candy = register(ITEMS, "candy", new Candy());
    public static final Item ceviche = register(ITEMS, "ceviche", CrockPotFood.builder().nutrition(7).saturationMod(0.7F).alwaysEat().effect(Effects.DAMAGE_RESISTANCE, 20 * 20, 1).effect(Effects.ABSORPTION, 20 * 20, 1).build());
    public static final Item fishSticks = register(ITEMS, "fish_sticks", CrockPotFood.builder().nutrition(7).saturationMod(0.7F).effect(Effects.REGENERATION, 30 * 20).build());
    ...
    public static final Item fruitMedley = register(ITEMS, "fruit_medley", CrockPotFood.builder().nutrition(8).saturationMod(0.4F).effect(Effects.MOVEMENT_SPEED, 3 * 60 * 20).build());
    public static final Item gazpacho = register(ITEMS, "gazpacho", CrockPotFood.builder().nutrition(6).saturationMod(0.4F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(Effects.FIRE_RESISTANCE, 10 * 60 * 20).build());
    public static final Item honeyHam = register(ITEMS, "honey_ham", CrockPotFood.builder().nutrition(12).saturationMod(0.8F).effect(Effects.REGENERATION, 20 * 20).effect(Effects.ABSORPTION, 60 * 20, 1).heal(6.0F).build());
    public static final Item honeyNuggets = register(ITEMS, "honey_nuggets", CrockPotFood.builder().nutrition(8).saturationMod(0.3F).effect(Effects.REGENERATION, 10 * 20).effect(Effects.ABSORPTION, 60 * 20).heal(4.0F).build());
    public static final Item hotChili = register(ITEMS, "hot_chili", CrockPotFood.builder().nutrition(9).saturationMod(0.8F).effect(Effects.DAMAGE_BOOST, (60 + 30) * 20).effect(Effects.DIG_SPEED, (60 + 30) * 20).build());
    public static final Item hotCocoa = register(ITEMS, "hot_cocoa", CrockPotFood.builder().nutrition(2).saturationMod(0.1F).alwaysEat().drink().effect(Effects.MOVEMENT_SPEED, 8 * 60 * 20, 1).removeEffect(Effects.MOVEMENT_SLOWDOWN).removeEffect(Effects.DIG_SLOWDOWN).build());
    public static final Item iceCream = register(ITEMS, "ice_cream", new IceCream());
    public static final Item icedTea = register(ITEMS, "iced_tea", CrockPotFood.builder().nutrition(3).saturationMod(0.1F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(Effects.MOVEMENT_SPEED, 10 * 60 * 20, 1).effect(Effects.JUMP, 5 * 60 * 20, 1).build());
    ...
    public static final Item monsterLasagna = register(ITEMS, "monster_lasagna", CrockPotFood.builder().nutrition(7).saturationMod(0.2F).effect(Effects.HUNGER, 15 * 20).effect(Effects.POISON, 2 * 20).damage(CrockPotDamageSource.MONSTER_FOOD, 6.0F).build());
    public static final Item monsterTartare = register(ITEMS, "monster_tartare", CrockPotFood.builder().nutrition(8).saturationMod(0.7F).effect(Effects.DAMAGE_BOOST, 2 * 60 * 20, 1).build());
    public static final Item moqueca = register(ITEMS, "moqueca", CrockPotFood.builder().nutrition(14).saturationMod(0.7F).duration(FoodUseDuration.SLOW).effect(Effects.HEALTH_BOOST, (60 + 30) * 20, 2).heal(6.0F).build());
    ...
    public static final Item pepperPopper = register(ITEMS, "pepper_popper", CrockPotFood.builder().nutrition(8).saturationMod(0.8F).effect(Effects.DAMAGE_BOOST, 60 * 20, 1).build());
    ...
    public static final Item potatoSouffle = register(ITEMS, "potato_souffle", CrockPotFood.builder().nutrition(8).saturationMod(0.7F).effect(Effects.DAMAGE_RESISTANCE, (60 + 30) * 20, 1).build());
    public static final Item potatoTornado = register(ITEMS, "potato_tornado", CrockPotFood.builder().nutrition(8).saturationMod(0.6F).duration(FoodUseDuration.FAST).removeEffect(Effects.HUNGER).build());
    ...
    public static final Item pumpkinCookie = register(ITEMS, "pumpkin_cookie", CrockPotFood.builder().nutrition(10).saturationMod(0.7F).duration(FoodUseDuration.FAST).removeEffect(Effects.HUNGER).build());
    ...
    public static final Item salsa = register(ITEMS, "salsa", CrockPotFood.builder().nutrition(7).saturationMod(0.8F).duration(FoodUseDuration.FAST).effect(Effects.DIG_SPEED, 6 * 60 * 20).build());
    public static final Item seafoodGumbo = register(ITEMS, "seafood_gumbo", CrockPotFood.builder().nutrition(9).saturationMod(0.7F).effect(Effects.REGENERATION, 2 * 60 * 20).build());
    ...
    public static final Item surfNTurf = register(ITEMS, "surf_n_turf", CrockPotFood.builder().nutrition(8).saturationMod(1.2F).alwaysEat().effect(Effects.REGENERATION, 30 * 20, 1).heal(8.0F).build());
    public static final Item taffy = register(ITEMS, "taffy", CrockPotFood.builder().nutrition(5).saturationMod(0.4F).duration(FoodUseDuration.FAST).alwaysEat().effect(Effects.LUCK, 8 * 60 * 20).damage(CrockPotDamageSource.TAFFY, 1.0F).removeEffect(Effects.POISON).build());
    public static final Item tea = register(ITEMS, "tea", CrockPotFood.builder().nutrition(3).saturationMod(0.6F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(Effects.MOVEMENT_SPEED, 10 * 60 * 20, 1).effect(Effects.DIG_SPEED, 5 * 60 * 20, 1).build());
    ...
    public static final Item turkeyDinner = register(ITEMS, "turkey_dinner", CrockPotFood.builder().nutrition(12).saturationMod(0.8F).effect(Effects.HEALTH_BOOST, 3 * 60 * 20).build());
    public static final Item vegStinger = register(ITEMS, "veg_stinger", CrockPotFood.builder().nutrition(6).saturationMod(0.3F).duration(FoodUseDuration.FAST).alwaysEat().drink().effect(Effects.NIGHT_VISION, 10 * 60 * 20).build());
    public static final Item watermelonIcle = register(ITEMS, "watermelon_icle", CrockPotFood.builder().nutrition(5).saturationMod(0.4F).duration(FoodUseDuration.FAST).effect(Effects.MOVEMENT_SPEED, 3 * 60 * 20).effect(Effects.JUMP, 3 * 60 * 20).removeEffect(Effects.MOVEMENT_SLOWDOWN).build());
    public static final Item wetGoop = register(ITEMS, "wet_goop", CrockPotFood.builder().nutrition(0).saturationMod(0.0F).duration(FoodUseDuration.SUPER_SLOW).alwaysEat().effect(Effects.CONFUSION, 10 * 20).tooltip("wet_goop", TextFormatting.DARK_AQUA).build());
