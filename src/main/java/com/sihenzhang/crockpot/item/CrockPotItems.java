...
public final class CrockPotItems {
    ...
    public static final RegistryObject<Item> BACON_EGGS = ITEMS.register("bacon_eggs", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BACON_EGGS.get(), CrockPotFoodProperties.builder(12, 0.8F).heal(4.0F).build()));
    public static final RegistryObject<Item> BONE_SOUP = ITEMS.register("bone_soup", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BONE_SOUP.get(), CrockPotFoodProperties.builder(10, 0.6F).effect(MobEffects.ABSORPTION, 2 * 60 * 20, 1).build()));
    public static final RegistryObject<Item> BONE_STEW = ITEMS.register("bone_stew", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BONE_STEW.get(), CrockPotFoodProperties.builder(20, 0.4F).duration(FoodUseDuration.SUPER_SLOW).effect(MobEffects.HEAL, 1, 1).build()));
    public static final RegistryObject<Item> BREAKFAST_SKILLET = ITEMS.register("breakfast_skillet", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BREAKFAST_SKILLET.get(), CrockPotFoodProperties.builder(8, 0.8F).build()));
    public static final RegistryObject<Item> BUNNY_STEW = ITEMS.register("bunny_stew", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BUNNY_STEW.get(), CrockPotFoodProperties.builder(6, 0.8F).effect(MobEffects.REGENERATION, 5 * 20).effect(CrockPotEffects.WELL_FED, 2 * 60 * 20).build()));
    public static final RegistryObject<Item> CALIFORNIA_ROLL = ITEMS.register("california_roll", () -> new CrockPotFoodBlockItem(CrockPotBlocks.CALIFORNIA_ROLL.get(), CrockPotFoodProperties.builder(10, 0.6F).heal(4.0F).effect(MobEffects.ABSORPTION, 60 * 20).build()));
    public static final RegistryObject<Item> CANDY = ITEMS.register("candy", CandyItem::new);
    public static final RegistryObject<Item> CEVICHE = ITEMS.register("ceviche", () -> new CrockPotFoodBlockItem(CrockPotBlocks.CEVICHE.get(), CrockPotFoodProperties.builder(7, 0.7F).alwaysEat().effect(MobEffects.DAMAGE_RESISTANCE, 20 * 20, 1).effect(MobEffects.ABSORPTION, 20 * 20, 1).build()));
    public static final RegistryObject<Item> FISH_STICKS = ITEMS.register("fish_sticks", () -> new CrockPotFoodBlockItem(CrockPotBlocks.FISH_STICKS.get(), CrockPotFoodProperties.builder(7, 0.7F).effect(MobEffects.REGENERATION, 30 * 20).build()));
    public static final RegistryObject<Item> FISH_TACOS = ITEMS.register("fish_tacos", () -> new CrockPotFoodBlockItem(CrockPotBlocks.FISH_TACOS.get(), CrockPotFoodProperties.builder(8, 0.9F).heal(2.0F).build()));
    public static final RegistryObject<Item> FLOWER_SALAD = ITEMS.register("flower_salad", FlowerSaladItem::new);
    public static final RegistryObject<Item> FROGGLE_BUNWICH = ITEMS.register("froggle_bunwich", () -> new CrockPotFoodBlockItem(CrockPotBlocks.FROGGLE_BUNWICH.get(), CrockPotFoodProperties.builder(7, 0.8F).build()));
    ...
    public static final RegistryObject<Item> HONEY_HAM = ITEMS.register("honey_ham", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HONEY_HAM.get(), CrockPotFoodProperties.builder(12, 0.8F).effect(MobEffects.REGENERATION, 20 * 20).effect(MobEffects.ABSORPTION, 60 * 20, 1).heal(6.0F).build()));
    public static final RegistryObject<Item> HONEY_NUGGETS = ITEMS.register("honey_nuggets", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HONEY_NUGGETS.get(), CrockPotFoodProperties.builder(8, 0.3F).effect(MobEffects.REGENERATION, 10 * 20).effect(MobEffects.ABSORPTION, 60 * 20).heal(4.0F).build()));
    public static final RegistryObject<Item> HOT_CHILI = ITEMS.register("hot_chili", () -> new CrockPotFoodBlockItem(CrockPotBlocks.HOT_CHILI.get(), CrockPotFoodProperties.builder(9, 0.8F).effect(MobEffects.DAMAGE_BOOST, (60 + 30) * 20).effect(MobEffects.DIG_SPEED, (60 + 30) * 20).build()));
    ...
    public static final RegistryObject<Item> KABOBS = ITEMS.register("kabobs", () -> new CrockPotFoodBlockItem(CrockPotBlocks.KABOBS.get(), CrockPotFoodProperties.builder(7, 0.7F).build()));
    public static final RegistryObject<Item> MASHED_POTATOES = ITEMS.register("mashed_potatoes", () -> new CrockPotFoodItem(CrockPotFoodProperties.builder(9, 0.6F).effect(MobEffects.DAMAGE_RESISTANCE, 4 * 60 * 20).build()));
    public static final RegistryObject<Item> MEAT_BALLS = ITEMS.register("meat_balls", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MEAT_BALLS.get(), CrockPotFoodProperties.builder(9, 0.5F).build()));
    public static final RegistryObject<Item> MONSTER_LASAGNA = ITEMS.register("monster_lasagna", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MONSTER_LASAGNA.get(), CrockPotFoodProperties.builder(7, 0.2F).effect(MobEffects.HUNGER, 15 * 20).effect(MobEffects.POISON, 2 * 20).damage(CrockPotDamageTypes.MONSTER_FOOD, 6.0F).build()));
    public static final RegistryObject<Item> MONSTER_TARTARE = ITEMS.register("monster_tartare", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MONSTER_TARTARE.get(), CrockPotFoodProperties.builder(8, 0.7F).effect(MobEffects.DAMAGE_BOOST, 2 * 60 * 20, 1).build()));
    public static final RegistryObject<Item> MOQUECA = ITEMS.register("moqueca", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MOQUECA.get(), CrockPotFoodProperties.builder(14, 0.7F).duration(FoodUseDuration.SLOW).effect(MobEffects.HEALTH_BOOST, (60 + 30) * 20, 2).heal(6.0F).build()));
    ...
    public static final RegistryObject<Item> PEPPER_POPPER = ITEMS.register("pepper_popper", () -> new CrockPotFoodBlockItem(CrockPotBlocks.PEPPER_POPPER.get(), CrockPotFoodProperties.builder(8, 0.8F).effect(MobEffects.DAMAGE_BOOST, 60 * 20, 1).build()));
    public static final RegistryObject<Item> PEROGIES = ITEMS.register("perogies", () -> new CrockPotFoodBlockItem(CrockPotBlocks.PEROGIES.get(), CrockPotFoodProperties.builder(8, 0.8F).heal(6.0F).build()));
    public static final RegistryObject<Item> PLAIN_OMELETTE = ITEMS.register("plain_omelette", () -> new CrockPotFoodBlockItem(CrockPotBlocks.PLAIN_OMELETTE.get(), CrockPotFoodProperties.builder(7, 0.6F).build()));
    ...
    public static final RegistryObject<Item> SALMON_SUSHI = ITEMS.register("salmon_sushi", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SALMON_SUSHI.get(), CrockPotFoodProperties.builder(5, 0.8F).duration(FoodUseDuration.FAST).heal(1.0F).build()));
    ...
    public static final RegistryObject<Item> SCOTCH_EGG = ITEMS.register("scotch_egg", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SCOTCH_EGG.get(), CrockPotFoodProperties.builder(8, 1.0F).build()));
    public static final RegistryObject<Item> SEAFOOD_GUMBO = ITEMS.register("seafood_gumbo", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SEAFOOD_GUMBO.get(), CrockPotFoodProperties.builder(9, 0.7F).effect(MobEffects.REGENERATION, 2 * 60 * 20).build()));
    ...
    public static final RegistryObject<Item> SURF_N_TURF = ITEMS.register("surf_n_turf", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SURF_N_TURF.get(), CrockPotFoodProperties.builder(8, 1.2F).alwaysEat().effect(MobEffects.REGENERATION, 30 * 20, 1).heal(8.0F).build()));
    ...
    public static final RegistryObject<Item> TROPICAL_BOUILLABAISSE = ITEMS.register("tropical_bouillabaisse", () -> new CrockPotFoodBlockItem(CrockPotBlocks.TROPICAL_BOUILLABAISSE.get(), CrockPotFoodProperties.builder(7, 0.6F).alwaysEat().effect(CrockPotEffects.OCEAN_AFFINITY, (2 * 60 + 30) * 20).build()));
    public static final RegistryObject<Item> TURKEY_DINNER = ITEMS.register("turkey_dinner", () -> new CrockPotFoodBlockItem(CrockPotBlocks.TURKEY_DINNER.get(), CrockPotFoodProperties.builder(12, 0.8F).effect(MobEffects.HEALTH_BOOST, 3 * 60 * 20).build()));
    ...
    public static final RegistryObject<Item> VOLT_GOAT_JELLY = ITEMS.register("volt_goat_jelly", () -> new CrockPotFoodItem(CrockPotFoodProperties.builder(4, 0.6F).alwaysEat().effect(CrockPotEffects.CHARGE.get(), 6 * 60 * 20).build()));
