...
public final class CrockPotItems {
    ...
    public static final RegistryObject<Item> VOLT_GOAT_JELLY = ITEMS.register("volt_goat_jelly", () -> new CrockPotFoodItem(CrockPotFoodProperties.builder(4, 0.6F).alwaysEat().effect(CrockPotEffects.CHARGE.get(), 6 * 60 * 20).meat().build()));
