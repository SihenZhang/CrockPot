...
public final class CrockPotItems {
    ...
    public static final RegistryObject<Item> PORTABLE_CROCK_POT = ITEMS.register("portable_crock_pot", () -> new CrockPotBlockItem(CrockPotBlocks.PORTABLE_CROCK_POT.get(), new Item.Properties().rarity(Rarity.UNCOMMON)));
    ...
    public static final RegistryObject<Item> BONE_SOUP = ITEMS.register("bone_soup", () -> new CrockPotFoodBlockItem(CrockPotBlocks.BONE_SOUP.get(), CrockPotFoodProperties.builder(10, 0.6F).effect(MobEffects.ABSORPTION, 2 * 60 * 20, 1).meat().rarity(Rarity.UNCOMMON).build()));
    ...
    public static final RegistryObject<Item> GUMMY_CAKE = ITEMS.register("gummy_cake", () -> new CrockPotFoodBlockItem(CrockPotBlocks.GUMMY_CAKE.get(), CrockPotFoodProperties.builder(12, 0.1F).duration(FoodUseDuration.SLOW).effect(MobEffects.MOVEMENT_SLOWDOWN, 10 * 20, 0.8F).build()));
    ...
    public static final RegistryObject<Item> MONSTER_TARTARE = ITEMS.register("monster_tartare", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MONSTER_TARTARE.get(), CrockPotFoodProperties.builder(8, 0.7F).effect(MobEffects.DAMAGE_BOOST, 2 * 60 * 20, 1).meat().rarity(Rarity.UNCOMMON).build()));
    public static final RegistryObject<Item> MOQUECA = ITEMS.register("moqueca", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MOQUECA.get(), CrockPotFoodProperties.builder(14, 0.7F).duration(FoodUseDuration.SLOW).effect(MobEffects.HEALTH_BOOST, (60 + 30) * 20, 2).heal(6.0F).meat().rarity(Rarity.UNCOMMON).build()));
    public static final RegistryObject<Item> MUSHY_CAKE = ITEMS.register("mushy_cake", () -> new CrockPotFoodBlockItem(CrockPotBlocks.MUSHY_CAKE.get(), CrockPotFoodProperties.builder(6, 0.4F).duration(FoodUseDuration.FAST).alwaysEat().effect(CrockPotEffects.WITHER_RESISTANCE, 60 * 20).rarity(Rarity.UNCOMMON).build()));
    ...
    public static final RegistryObject<Item> POTATO_SOUFFLE = ITEMS.register("potato_souffle", () -> new CrockPotFoodBlockItem(CrockPotBlocks.POTATO_SOUFFLE.get(), CrockPotFoodProperties.builder(8, 0.7F).effect(MobEffects.DAMAGE_RESISTANCE, (60 + 30) * 20, 1).rarity(Rarity.UNCOMMON).build()));
    ...
    public static final RegistryObject<Item> SNAKE_BONE_SOUP = ITEMS.register("snake_bone_soup", () -> new CrockPotFoodBlockItem(CrockPotBlocks.SNAKE_BONE_SOUP.get(), CrockPotFoodProperties.builder(5, 0.9F).heal(6.0F).meat().build()));
    public static final RegistryObject<Item> STEAMED_HAM_SANDWICH = ITEMS.register("steamed_ham_sandwich", () -> new CrockPotFoodBlockItem(CrockPotBlocks.STEAMED_HAM_SANDWICH.get(), CrockPotFoodProperties.builder(10, 0.8F).heal(4.0F).meat().build()));
    ...
    public static final RegistryObject<Item> VOLT_GOAT_JELLY = ITEMS.register("volt_goat_jelly", () -> new CrockPotFoodBlockItem(CrockPotBlocks.VOLT_GOAT_JELLY.get(), CrockPotFoodProperties.builder(4, 0.6F).alwaysEat().effect(CrockPotEffects.CHARGE.get(), 6 * 60 * 20).meat().rarity(Rarity.UNCOMMON).build()));
    ...
    public static final Supplier<List<Item>> FOODS_WITHOUT_AVAJ = Suppliers.memoize(() -> List.of(
            ...
            SALSA.get(), SCOTCH_EGG.get(), SEAFOOD_GUMBO.get(), SNAKE_BONE_SOUP.get(), STEAMED_HAM_SANDWICH.get(),
            STUFFED_EGGPLANT.get(), SURF_N_TURF.get(), TAFFY.get(), TEA.get(), TROPICAL_BOUILLABAISSE.get(),
            TURKEY_DINNER.get(), VEG_STINGER.get(), VOLT_GOAT_JELLY.get(), WATERMELON_ICLE.get()
    ));
