...
public class CrockPotItemTagsProvider extends ItemTagsProvider {
    public CrockPotItemTagsProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> providerFuture, CompletableFuture<TagLookup<Block>> blockTagsProviderFuture, @Nullable ExistingFileHelper existingFileHelper) {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        // Pot
        this.copy(ModBlockTags.CROCK_POTS, ModItemTags.CROCK_POTS);
