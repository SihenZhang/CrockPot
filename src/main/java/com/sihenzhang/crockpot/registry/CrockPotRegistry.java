...
public final class CrockPotRegistry {
    ...
    // Foods
    public static RegistryObject<Item> asparagusSoup = ITEMS.register("asparagus_soup", () -> new CrockPotBaseItemFood(5, 1.5F, () -> new EffectInstance(Effects.SPEED, 60 * 20), () -> new EffectInstance(Effects.HASTE, 60 * 20), 24, true));
    ...
    public static RegistryObject<Item> fishSticks = ITEMS.register("fish_sticks", () -> new CrockPotBaseItemFood(7, 4.2F, () -> new EffectInstance(Effects.INSTANT_HEALTH, 1)));
    ...
    public static RegistryObject<Item> fruitMedley = ITEMS.register("fruit_medley", () -> new CrockPotBaseItemFood(8, 4.8F, () -> new EffectInstance(Effects.HASTE, 3 * 60 * 20, 1)));
    public static RegistryObject<Item> gazpacho = ITEMS.register("gazpacho", () -> new CrockPotBaseItemFood(6, 1.8F, true));
    public static RegistryObject<Item> honeyHam = ITEMS.register("honey_ham", () -> new CrockPotBaseItemFood(12, 7.2F, () -> new EffectInstance(Effects.REGENERATION, 5 * 20, 1)));
    public static RegistryObject<Item> honeyNuggets = ITEMS.register("honey_nuggets", () -> new CrockPotBaseItemFood(8, 2.4F, () -> new EffectInstance(Effects.REGENERATION, 5 * 20)));
    public static RegistryObject<Item> hotChili = ITEMS.register("hot_chili", () -> new CrockPotBaseItemFood(8, 4.8F, () -> new EffectInstance(Effects.STRENGTH, 60 * 20), () -> new EffectInstance(Effects.HASTE, 60 * 20)));
    public static RegistryObject<Item> hotCocoa = ITEMS.register("hot_cocoa", () -> new CrockPotAlwaysEdibleItemFood(2, 0.2F, () -> new EffectInstance(Effects.SPEED, 4 * 60 * 20, 1), 24, true));
    public static RegistryObject<Item> iceCream = ITEMS.register("ice_cream", IceCream::new);
    public static RegistryObject<Item> icedTea = ITEMS.register("iced_tea", () -> new CrockPotAlwaysEdibleItemFood(3, 0.3F, () -> new EffectInstance(Effects.SPEED, (60 + 30) * 20, 1), () -> new EffectInstance(Effects.HASTE, (60 + 30) * 20), 24, true));
    ...
    public static RegistryObject<Item> moqueca = ITEMS.register("moqueca", () -> new CrockPotBaseItemFood(17, 10.2F, () -> new EffectInstance(Effects.RESISTANCE, 30 * 20, 1), () -> new EffectInstance(Effects.REGENERATION, 5 * 20, 1), 40));
    ...
    public static RegistryObject<Item> seafoodGumbo = ITEMS.register("seafood_gumbo", () -> new CrockPotBaseItemFood(8, 4.8F, () -> new EffectInstance(Effects.INSTANT_HEALTH, 1, 1), 24));
    ...
    public static RegistryObject<Item> tea = ITEMS.register("tea", () -> new CrockPotAlwaysEdibleItemFood(3, 0.3F, () -> new EffectInstance(Effects.SPEED, (60 + 30) * 20, 1), () -> new EffectInstance(Effects.REGENERATION, 20 * 20), 24, true));
    ...
    public static RegistryObject<Item> vegStinger = ITEMS.register("veg_stinger", () -> new CrockPotAlwaysEdibleItemFood(6, 1.8F, () -> new EffectInstance(Effects.FIRE_RESISTANCE, 5 * 60 * 20), 24, true));
