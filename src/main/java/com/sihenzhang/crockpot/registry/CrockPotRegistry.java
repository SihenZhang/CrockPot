...
public class CrockPotRegistry {
    ...
    public static RegistryObject<Item> hotChili = ITEMS.register("hot_chili", () -> new CrockPotBaseItemFood(8, 4.8F, () -> new EffectInstance(Effects.STRENGTH, (60 + 30) * 20), () -> new EffectInstance(Effects.HASTE, (60 + 30) * 20, 1)));
    ...
    public static RegistryObject<Item> icedTea = ITEMS.register("iced_tea", () -> new CrockPotAlwaysEdibleItemFood(3, 1.8F, () -> new EffectInstance(Effects.SPEED, (60 + 30) * 20, 1), 24, true));
    ...
    public static RegistryObject<Item> potatoTornado = ITEMS.register("potato_tornado", () -> new CrockPotBaseItemFood(6, 3.6F, 24));
    ...
    public static RegistryObject<Item> tea = ITEMS.register("tea", () -> new CrockPotAlwaysEdibleItemFood(3, 1.8F, () -> new EffectInstance(Effects.SPEED, 3 * 60 * 20, 1), () -> new EffectInstance(Effects.HASTE, 3 * 60 * 20, 1), 24, true));
