    ...
    public IVariable process(String key) {
        return switch (key) {
            ...
            case "explosionTooltip" ->
                    IVariable.from(Component.translatable("integration.crockpot.book.explosion_crafting.explosion"));
            case "isOnlyBlock" -> IVariable.wrap(recipe.isOnlyBlock());
            case "onlyBlockTooltip" ->
                    IVariable.from(Component.translatable("integration.crockpot.book.explosion_crafting.only_block"));
